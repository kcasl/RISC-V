...
`define RISCV_REG_MUL_A_SIGNED    (`RISCV_MULTIPLIER_BASE_ADDR + 32'h04)
`define RISCV_REG_MUL_B_SIGNED    (`RISCV_MULTIPLIER_BASE_ADDR + 32'h08)
`define RISCV_REG_MUL_A_I         (`RISCV_MULTIPLIER_BASE_ADDR + 32'h0C)
`define RISCV_REG_MUL_B_I         (`RISCV_MULTIPLIER_BASE_ADDR + 32'h10)
