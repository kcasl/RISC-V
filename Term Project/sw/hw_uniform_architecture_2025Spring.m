...
model_name = '2025Spring';        % Final project
...
% [FIX] MATLAB script names cannot start with a digit.
%       run('2025Spring') is parsed as 2025*Spring → use arch_2025Spring.m instead.
%       model_name stays '2025Spring' for weight/hex folder paths.
run('arch_2025Spring')
