...
/* insert your code */
// [FILLED] Remaining multipliers for Ti=16 MAC array
...
always@(posedge clk, negedge rstn) begin
	if(~rstn) begin
		...
		/* insert your code */
		// [FILLED] Level-2 adder tree complete above; Level 3/4 below
		// Level 3
		...
		// Level 4
		/* insert your code */
		// [FILLED] Final adder: reduce to single MAC sum
...
always@(posedge clk, negedge rstn) begin
	if(~rstn) begin
		...
		/* insert your code */
		// [FILLED] Pipeline valid to match adder-tree latency (WN+1 stages)
