...
parameter N  = 16;
// [MODIFIED] Term Project 2026 Summer - Problem 1-4b/c
// 2025Spring: 8 CONV layers (was 3 for baseline ESPCN)
parameter N_LAYER 		= 8;
...
initial begin
	...
	is_conv3x3          = 0;
	//---------------------------------------------------------------
	// [MODIFIED] Term Project 2026 Summer - Problem 1-4c / Table II
	// Configuration from test_vector_2025Spring.mat (bias_shift, act_shift)
	// and Table I (filter size -> q_is_conv3x3).
	// Layer1 (first): 3x3 but packed as merged first-layer -> is_conv3x3=0
	// Layer2: 1x1, Layer3-6: 3x3, Layer7: 1x1, Layer8: 3x3 (last)
	//---------------------------------------------------------------
	q_bias_shift[0] = 16; q_act_shift[0] = 1; q_is_conv3x3[0] = 0; // L1 first/merged 3x3
	q_bias_shift[1] = 22; q_act_shift[1] = 1; q_is_conv3x3[1] = 0; // L2 1x1
	q_bias_shift[2] = 23; q_act_shift[2] = 1; q_is_conv3x3[2] = 1; // L3 3x3
	q_bias_shift[3] = 23; q_act_shift[3] = 1; q_is_conv3x3[3] = 1; // L4 3x3
	q_bias_shift[4] = 23; q_act_shift[4] = 1; q_is_conv3x3[4] = 1; // L5 3x3
	q_bias_shift[5] = 23; q_act_shift[5] = 1; q_is_conv3x3[5] = 1; // L6 3x3
	q_bias_shift[6] = 23; q_act_shift[6] = 0; q_is_conv3x3[6] = 0; // L7 1x1
	q_bias_shift[7] = 24; q_act_shift[7] = 0; q_is_conv3x3[7] = 1; // L8 3x3 last
	// Loop/Layer index
	idx = 0;
